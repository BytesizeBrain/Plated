      ...
      {post.recipe_data && (
        <div className="post-recipe-info">
          <div className="recipe-meta">
            {(post.recipe_data.cooking_time || post.recipe_data.prep_time || post.recipe_data.cook_time) && (
              <span className="recipe-tag">
                ...
                {post.recipe_data.cooking_time ||
                 (post.recipe_data.prep_time && post.recipe_data.cook_time
                   ? post.recipe_data.prep_time + post.recipe_data.cook_time
                   : post.recipe_data.cook_time || post.recipe_data.prep_time)} min
              </span>
            )}
                ...
                <div className="recipe-section">
                  ...
                  <ol className="instructions-list">
                    {post.recipe_data.instructions.map((instruction, index) => (
                      <li key={index}>{String(instruction)}</li>
                    ))}
                  </ol>
                </div>
              )}
